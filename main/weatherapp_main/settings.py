"""
Django settings for weatherapp_main project.
...
ROOT_URLCONF = "weatherapp_main.urls"
...
WSGI_APPLICATION = "weatherapp_main.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "weatherapp_main"),
